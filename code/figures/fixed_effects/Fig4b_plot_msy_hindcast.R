...
# Setup figure
figname <- "Fig4_msy_hindcast_fixed_random.png"
...
# Read hindcast data
load(paste(datadir, "ramldb_v3.8_pella4_0.20_cobe_fixed_msy_hindcast.Rdata", sep="/"))
...
# Read hindcast data
load(paste(datadir, "ramldb_v3.8_pella4_0.20_cobe_random_msy_hindcast.Rdata", sep="/"))
