...
plot(msy ~ year, msy_df, type="n", bty="n", cex.lab=1.2, cex.axis=1.05, las=1,
     xaxt="n", xlab="", ylab="MSY (millions of mt)", ylim=c(35,50))
...
text(x=1934, y=49.48, pos=4, labels=paste(sum(n_inf), "populations"), cex=1.05)
...
plot(msy ~ year, msy_pos_df, type="n", bty="n", las=1, cex.axis=1.05,
     xaxt="n", xlab="", ylab="", ylim=c(0.3,0.6), yaxt="n")
axis(1, at=seq(yr1, yr2, 10), labels=F)
axis(2, at=seq(0.3, 0.6, 0.1), cex.axis=1.05, las=1)
...
text(x=1934, y=0.6-(0.6-0.3)*0.07, pos=4, labels=paste(n_inf["positive"], "populations"), cex=1.05)
...
plot(msy ~ year, msy_neg_df, type="n", bty="n", las=1, cex.axis=1.05, 
     xaxt="n", xlab="", ylab="MSY (millions of mt)", ylim=c(1,4), yaxt="n",cex.lab=1.2)
axis(1, at=seq(yr1, yr2, 10), labels=F)
axis(2, at=1:4, cex.axis=1.05, las=1)
...
text(x=1934, y=4-(4-1)*0.07, pos=4, labels=paste(n_inf["negative"], "populations"), cex=1.05)
...
text(x=1934, y=50-(50-35)*0.07, pos=4, labels=paste(n_inf["none"], "populations"), cex=1.05)
