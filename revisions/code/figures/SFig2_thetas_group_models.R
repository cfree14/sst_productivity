...
# Setup figure
figname <- "SFig2_thetas_group_models.png"
...
# Loop through models
model_objs <- paste0("ramldb_v3.8_sp_ar1_pella0.55_cobe_", c("order", "family", "fao_area", "lme", "method"), ".Rdata") # , "method1"
model_names <- c("Order", "Family", "FAO area", "Ecoregion", "Stock assessment method") # "Generic assessment method", "Specific assessment method")
