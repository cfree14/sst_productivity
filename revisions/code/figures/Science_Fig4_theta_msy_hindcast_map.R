...
data$perc_bin <- cut(data$pdiff, breaks=seq(-35,35,5))
...
# Setup figure
# figname <- "Science_Fig4_msy_hindcast_map.png"
# png(paste(plotdir, figname, sep="/"), width=6.5, height=3, units="in", res=600)
figname <- "Science_Fig4_msy_hindcast_map.pdf"
pdf(paste(plotdir, figname, sep="/"), width=6.5, height=3)
